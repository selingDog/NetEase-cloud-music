<template>
  <div class="commentList">
    <div class="cmtItem" v-for="item in commentList.comments" :key="item.id">
      <div class="cmt_head">
        <a class="lsthd_link" :href="`//music.163.com/m/user?id=${item.user.userId}`">
          <div class="user_img">
            <img class="u_img" :src="item.user.avatarUrl" />
            <span class="icon u_icon" v-if="item.user.userType === 200 || item.user.userType === 207"></span>
            <span class="icon v_icon" v-if="item.user.userType === 2 || item.user.userType === 3"></span>
      ...
      <div class="cmt_wrap">
        <div class="cmt_header">
          <div class="cmt_meta">
            <span class="cmt_user">
              ...
              <img src="../assets/vipIcon.webp" alt="" class="vip" v-if="item.user.vipType" />
            </span>
            <div class="cmt_time">{{ item.timeStr }}</div>
          </div>
        ...
        <div class="cmt_content">
          <span class="cmt_text" v-if="item.beReplied[0]">
            回复
            <a :href="`//music.163.com/m/user?id=${item.beReplied[0].user.userId}`" class="at">@{{
